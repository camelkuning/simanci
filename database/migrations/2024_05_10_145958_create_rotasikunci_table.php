...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('rotasikunci', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('id_satpam');
            $table->foreign('id_satpam')->references('id')->on('users');
    ...
    {
        Schema::table('rotasikunci', function (Blueprint $table) {
            $table->dropForeign(['id_satpam']);
            $table->dropForeign(['id_kunci']);
            $table->dropForeign(['id_karyawan']);
            $table->dropForeign(['id_karyawan_pengembali']);
        });
